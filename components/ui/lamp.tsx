  ...
  return (
    <div
      ...
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
        ...
        <div className="-translate-y-1/2 absolute inset-auto z-50 h-36 w-[28rem] rounded-full bg-cyan-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="-translate-y-24 absolute inset-auto z-30 h-36 w-64 rounded-full bg-cyan-400 blur-2xl"></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="-translate-y-28 absolute inset-auto z-50 h-0.5 w-[30rem] bg-cyan-400"></motion.div>

        <div className="-translate-y-[12.5rem] absolute inset-auto z-40 h-44 w-full bg-slate-950"></div>
      </div>

      <div className="-translate-y-80 relative z-50 flex flex-col items-center px-5">{children}</div>
    </div>
  );
};
