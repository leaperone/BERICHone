      ...
      <div className="px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 md:pr-8">
            ...
            <p className="text-small text-default-500">Sourcing, Quality, Delivery — All In One</p>
            {/* TODO: social links */}
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 pt-8">
          <p className="text-small text-default-400">&copy; 2025 BE RICH ONE. All rights reserved.</p>
          {beiAnLinks.map((link) => (
            <Link
              key={link.label}
              href={link.to}
